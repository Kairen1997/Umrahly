defmodule UmrahlyWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: UmrahlyWeb.Gettext
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed top-2 right-2 mr-2 w-80 sm:w-96 z-50 rounded-lg p-3 ring-1 transition-all duration-300 ease-in-out",
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="mt-10 space-y-8 bg-[#EAD4AB]">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(UmrahlyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(UmrahlyWeb.Gettext, "errors", msg, opts)
    end
  end
