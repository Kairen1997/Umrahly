        ...
        <div class="sticky top-0">
          <nav class="mt-0">
            <div class="px-4 space-y-2 py-4">
              ...
              <!-- Active Bookings (incomplete flows) -->
              ...
              <!-- My Bookings -->
              <a href="/my-bookings" class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md transition-colors duration-200">
                <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"/>
                </svg>
                My Bookings
